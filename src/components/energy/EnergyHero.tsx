    ...
    <section className="relative w-full min-h-[90vh] bg-white flex flex-col lg:flex-row border-b border-slate-200">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 lg:px-20 pt-32 pb-24 lg:py-0 relative z-10 bg-white">
        <div className="max-w-xl w-full">
          ...
          >
            POWERING <br /> <span className="text-blue-600 italic">PROGRESS.</span>
          </motion.h1>
      ...
      <div className="w-full lg:w-1/2 relative min-h-[500px] lg:min-h-full overflow-hidden bg-slate-100">
        ...
        >
          <div className="text-3xl font-bold text-slate-900 mb-2 font-serif" style={{ fontFamily: "var(--font-playfair)" }}>Energy Asset</div>
          <p className="text-sm text-slate-500 font-medium">Tier-1 Industrial Solar Supply and Hybrid Microgrid Systems across regional technical nodes.</p>
        </motion.div>
      </div>
