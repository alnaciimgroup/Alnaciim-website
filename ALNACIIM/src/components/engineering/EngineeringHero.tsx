    ...
    <section className="relative w-full pt-24 pb-12 lg:pt-36 lg:pb-20 overflow-hidden bg-[#FAFBFF]">
      ...
      <div className="max-w-[1240px] mx-auto px-6 lg:px-12 relative z-10 flex flex-col items-center text-center">
       ...
       <div className="flex flex-col items-center justify-center text-center z-20 relative mt-6">
         ...
         >
           <Link href="/engineering/solutions" className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-primary text-white rounded-fluid font-[600] text-[14px] hover:bg-primary-dark transition-all shadow-fluid hover:-translate-y-0.5">
             Show Technical Capacity <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
           </Link>
